InsightSream AI Meeting Assistant
...
Hindi audio → Sarvam AI (translates directly to English, tuned for Indian languages/accents)
...
yt-dlp, pydub, ffmpeg
Transcription
openai-whisper (local), Sarvam AI (saaras:v3 API)
LLM orchestration
LangChain (LCEL), Mistral (mistral-small-latest)
Vector store / RAG
ChromaDB, HuggingFace sentence-transformers/all-MiniLM-L6-v2
Backend API
FastAPI, Uvicorn
Frontend
React (via CDN, no build step), vanilla CSS
